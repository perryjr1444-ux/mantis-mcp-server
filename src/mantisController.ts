...
export class MantisController {
  ...
  async getAttackStats(timeRange: string): Promise<AttackStats> {
    ...
    const stats: AttackStats = {
      ...
      llmAttacks: 143,
      humanAttacks: 7,
      successfulDefenses: 142,
      failedDefenses: 8,
      sessionsTrapped: 89,
      resourcesExhausted: {
        estimatedApiCalls: 45000,
        estimatedCost: 350.50,
        estimatedTime: 7200
      },
      topAttackVectors: [
        { vector: 'ssh_bruteforce', count: 65 },
        { vector: 'ftp_anonymous', count: 42 },
        { vector: 'web_sqli', count: 28 },
        { vector: 'port_scan', count: 15 }
      ],
      timeRange
    };
